    ...
    <div className="min-h-screen bg-[var(--grey-figma)] text-[var(--white-figma)]">
      <header className="w-full h-[100px] px-7 bg-[var(--black-figma)] flex justify-between items-center sticky top-0 z-50">
        <div className="flex gap-4 items-center">
          ...
          <h1 className="font-extrabold text-2xl"> RACOON<span className="text-[var(--orange-figma)]">WIF</span>CAP</h1>
        </div>
        <nav className="flex justify-between w-1/3">
          {SECTIONS.map((id) => (
            <a
      ...
      <main>
        <section id="about" className="min-h-screen p-8">ABOUT RACOON SECTION</section>
        <section id="buy" className="min-h-screen p-8">BUY RACOON SECTION</section>
        <section id="faq" className="min-h-screen p-8">FAQ RACOON SECTION</section>
        <section id="roadmap" className="min-h-screen p-8">ROADMAP RACOON SECTION</section>
      </main>
    </div>
  );
}
